...
$(d)smallbank_generator: $(LIB-io-utils) $(o)smallbank-proto.o $(o)smallbank_generator.o $(o)utils.o $(LIB-key-selector) $(LIB-bench-client) $(LIB-latency) $(LIB-tcptransport) $(LIB-udptransport) $(OBJS-all-store-clients) $(OBJS-all-bench-clients) $(LIB-bench-client) $(LIB-store-common)
