...
$(d)smallbank_transaction_test: $(LIB-io-utils) $(LIB-bench-client) $(LIB-store-frontend) $(LIB-latency) $(LIB-tcptransport) $(LIB-udptransport) $(LIB-smallbank) $(o)../../sync_transaction_bench_client.o $(o)../../bench_client.o $(o)smallbank_transaction_test.o $(GTEST_MAIN)

# TEST_BINS +=  $(addprefix $(d), smallbank_generator_test smallbank_client_test smallbank_transaction_test)
TEST_BINS +=  $(addprefix $(d), smallbank_transaction_test)