...
GTEST_SRCS += $(addprefix $(d), utils_test.cc smallbank_transaction_test.cc smallbank_generator_test.cc smallbank_client_test.cc ../../sync_transaction_bench_client.cc ../../bench_client.cc)
...
# TEST_BINS +=  $(addprefix $(d), smallbank_generator_test smallbank_client_test smallbank_transaction_test smallbank_utils_test)
TEST_BINS +=  $(addprefix $(d), smallbank_utils_test)
