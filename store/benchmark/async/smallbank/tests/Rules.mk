...
TEST_BINS +=  $(addprefix $(d), smallbank_generator_test smallbank_client_test smallbank_transaction_test smallbank_utils_test amalgamate_test bal_test deposit_test transact_test write_check_test)