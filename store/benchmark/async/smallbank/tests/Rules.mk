...
GTEST_SRCS += $(addprefix $(d), smallbank_generator_test.cc smallbank_client_test.cc ../../sync_transaction_bench_client.cc ../../bench_client.cc))
...
TEST_BINS +=  $(addprefix $(d), smallbank_generator_test smallbank_client_test)