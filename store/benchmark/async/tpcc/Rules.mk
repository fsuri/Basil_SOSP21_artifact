...
SRCS += $(addprefix $(d), tpcc_client.cc tpcc_transaction.cc random_generator.cc new_order.cc tpcc_generator.cc tpcc_utils.cc payment.cc)
...
LIB-tpcc := $(OBJ-tpcc-client) $(OBJ-tpcc-transaction) $(o)random_generator.o $(o)new_order.o \
	$(o)tpcc-proto.o $(o)tpcc_utils.o $(o)payment.o
