...
%-------------------------------------------------------------------------------
\iffalse
like you should be able to write everything except for the actual numbers
I normally have most of the text written down with \TODO{X} for the raw numbers to appear in red
and by writing an eval I don't mean just listening a list of questions, but bullet pointing it in detail so that it looks like the obladi/tapir/zyzyvva eval.
as a first draft I wouldn't necessarily worry about text
but I would say writing something like the 3 questions that we want to answer
followed by subsections that say what the goal of this section is, the setup of the experiment, and the results
it can be bullets
And you can probably iterate with matt on that too 
\fi
