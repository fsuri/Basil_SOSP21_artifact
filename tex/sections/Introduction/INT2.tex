...
Existing research attempts to mitigate the aforementioned scalability bottleneck through \changebars{
a combination of sharding, cross-shard atomic commit protocols and centralised ordering services which they layer atop the existing chain}{the application of sharding and cross-shard atomic commit protocols on - layer atop?}{a combination of sharding, cross-shard atomic commit protocols and centralised ordering services}~\cite{kokoris2018omniledger,al2017chainspace,padilha2016callinicos}. These systems suffer from three primary drawbacks \one ~ they limit the expressivity of the transactions they support \two ~ they introduce unnecessary coordination across replicas and finally,
