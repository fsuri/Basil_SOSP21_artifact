...
a combination of sharding and cross-shard atomic commit protocol, which they layer atop the totally ordered requests}{the application of sharding and cross-shard atomic commit protocols on - layer atop?}{a combination of sharding, cross-shard atomic commit protocols and centralised ordering services}~\cite{kokoris2018omniledger,al2017chainspace,padilha2016callinicos}. These systems suffer from three primary drawbacks \one ~ they limit the expressivity of the transactions they support \two ~ they introduce unnecessary coordination across replicas and finally,
