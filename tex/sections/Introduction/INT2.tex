...
Existing research attempts to mitigate the aforementioned scalability bottleneck through 
a combination of sharding \changebars{and cross-shard atomic commit protocols, which they layer atop the totally ordered requests}{, cross-shard atomic commit protocols and centralised ordering services}~\cite{kokoris2018omniledger,al2017chainspace,padilha2016callinicos}. These systems suffer from three primary drawbacks \one ~ they limit the expressivity of the transactions they support \two ~ they introduce unnecessary coordination across replicas and finally,
