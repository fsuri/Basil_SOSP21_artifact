...
\begin{theorem}[Liv] 
\changebars{Every transaction that a correct client is \textit{interested} in eventually completes.}{
...
\fbox{\begin{minipage}{21em}
\textbf{(5: R(FB) $\rightarrow$ R)}: Fallback replica aggregates and echos election messages.
\end{minipage}}
