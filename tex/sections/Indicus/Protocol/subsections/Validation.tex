...
A replica never changes its Voting decision, because re-execution could leave to different results. A replica starts a timer to monitor the clients progress.
