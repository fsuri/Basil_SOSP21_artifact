...
this prototype implements Basil, and offers replication, sharding and interactive transactions. The prototype uses cryptographically secure hash functions and signatures, and implements byzantine clients failing via Stalling or Equivocation, and is robust to both. The artifact contains, and allows to reproduce, experiments for all figures included in the paper.
