...
do
   ...
   rsync -v -r -e ssh /home/florian/Indicus/SOSP21_artifact_eval/src/bin/server fs435@$host.indicus.morty-pg0.utah.cloudlab.us:/users/fs435/indicus/bin
done
...
do
   echo "uploading binaries to $host"
   #ssh fs435@$host.indicus.morty-pg0.utah.cloudlab.us "sudo rm -rf /mnt/extra/experiments/*"
   rsync -v -r -e ssh /home/florian/Indicus/SOSP21_artifact_eval/src/bin/benchmark fs435@$host.indicus.morty-pg0.utah.cloudlab.us:/users/fs435/indicus/bin
done
