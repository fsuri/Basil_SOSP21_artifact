...
namespace bftsmartstore_stable {
    class IndicusInterface {
        ...
        //const std::string config_dir_base = "/home/yunhao/florian/BFT-DB/src/store/bftsmartstore_stable/libhotstuff/conf-indicus/";

        // on CloudLab
        const std::string config_dir_base = "/users/fs435/BFT-DB/src/store/bftsmartstore_stable/libhotstuff/conf-indicus";
