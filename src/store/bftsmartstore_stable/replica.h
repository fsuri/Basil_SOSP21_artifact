#ifndef _BFTSMART_STABLE_REPLICA_H_
#define _BFTSMART_STABLE_REPLICA_H_
...
#include "store/bftsmartstore_stable/slots.h"
...
#include "store/bftsmartstore_stable/libhotstuff/examples/indicus_interface.h"
