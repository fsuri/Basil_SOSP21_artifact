#ifndef _BFTSMART_STABLE_SERVER_H_
#define _BFTSMART_STABLE_SERVER_H_
...
public:
      ...
      bool TryLock(const proto::Transaction& txn, std::string &digest, class Server* server);
      bool ReleaseLock(const proto::Transaction& txn, const std::string &digest, class Server* server);
  };
